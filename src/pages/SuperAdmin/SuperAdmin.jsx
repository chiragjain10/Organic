...
const SuperAdmin = () => {
  ...
  const renderMetricCards = () => {
    ...
    const dynamicCards = [
      { label: "Total Users", value: users.length, trend: "Registered accounts" },
      { label: "Total Orders", value: orders.length, trend: "All time" },
      { label: "Revenue", value: `₹${totalRevenue}`, trend: "Total sales" },
      { label: "Products", value: products.length, trend: "Live catalog" },
    ];
    return (
      ...
      <aside className="w-64 border-r border-slate-100 bg-white/80 backdrop-blur-sm flex flex-col">
        <div className="px-6 py-5 border-b border-slate-100">
          <div className="flex items-center gap-2.5">
            <div className="h-9 w-9 rounded-xl bg-[#1E3D2B] text-white flex items-center justify-center text-sm font-semibold shadow-sm">
              SA
            </div>
            <div>
