...
const UserPanel = () => {
          ...
          return (
            <button
              ...
              className={`relative px-4 py-2 text-sm font-medium whitespace-nowrap rounded-t-lg transition-colors ${
                isActive
                  ? "text-[#1E3D2B]"
                  : "text-[#6B4F3F] hover:text-[#1E3D2B]"
              }`}
            >
              {tab}
              {isActive && (
                <span className="absolute inset-x-2 -bottom-px h-0.5 rounded-full bg-[#2F6F4E]" />
              )}
            </button>
          );
        })}
  ...
  return (
    <div className="min-h-screen bg-[#F7F6F2] text-[#1E3D2B]">
      <header className="border-b border-[#C5A880]/20 bg-white/80 backdrop-blur-sm">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-xl bg-[#2F6F4E] text-white flex items-center justify-center text-sm font-semibold shadow-sm">
              UP
            </div>
            <div>
              ...
              <p className="text-xs text-[#6B4F3F]">
                Personal wellness dashboard & activity
              </p>
            </div>
          </div>
          <div className="hidden sm:flex flex-col items-end text-xs">
            <span className="text-[#6B4F3F]">Signed in as</span>
